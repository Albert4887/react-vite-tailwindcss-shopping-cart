...
const ShoppingCart = () => {
  ...
  {cartItems.length !== 0 && (
    <div 
    className={`w-[300px] h-screen bg-gray-200 fixed top-0 z-30 
    ...
    >
        ...
        grid place-items-center border rounded-lg'>
            ...
            grid place-items-center border-2 rounded-full hover:bg-yellow-500 
            transition-colors' onClick={() => setIsOpen(false)}>
        ...
        place-items-center border-2 rounded-full' onClick={() => setIsOpen(true)}>
            ...
            <span className='w-6 h-6 bg-pink-400 absolute -bottom-4 -left-2 
            grid place-items-center border border-gray-300 rounded-full 
            text-sm text-white'>
        ...
        <div className='w-full h-20 bg-white absolute bottom-0 left-0 z-10 
        grid place-items-center border rounded-lg'>
